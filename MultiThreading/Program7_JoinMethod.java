	...
	In this  main thread is start and end first. however the default behaviour of main Thread is unaccepctable 
			...
			when we use the join() method checked exception occur then we ducking the exception.
...
class  Program7_JoinMethod
{
	public static void main(String[] args) throws Exception
	{
		System.out.println("Main Method Execution is Start");
			...
			d1.join();  //InterruptedException;
			d2.join();  //InterruptedException;
			d3.join(); //InterruptedException;
